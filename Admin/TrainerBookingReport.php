        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			 ...
			 $selQry = "select * from tbl_trainer";
				 ...
				 $rs = $con->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					 ...
					 $selQry2 = "select COALESCE(count(booking_id),0) as num from tbl_booking b inner join tbl_trainer c on c.trainer_id=b.trainer_id where b.trainer_id='".$data["trainer_id"]."'";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["trainer_name"]; ?></td>

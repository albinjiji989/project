...
<form action="" method="post" enctype="multipart/form-data" name="form1">
  ...
  <img src="../Assets/Files/Category/<?php echo $data['image'] ?>" width="200px"  />
      ...
      <td id="submit" align="center"><input type="submit" name="btnedit" id="btnedit" style="font-size: 20px;" value="Edit"><a href="update.php?did=<?php echo $data["category_id"]?>"style="color:white" class="GFG">Update</a></td>
    </tr>
    <?php
	}
	?>

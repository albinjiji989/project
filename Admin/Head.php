        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>FitQuest</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-check me-2"></i>Verification</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="TrainerVerification.php" class="dropdown-item">Trainer Verification</a>
                            <a href="NutritionistVerification.php" class="dropdown-item">Nutritionist Verification</a>
                           
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="Category.php" class="nav-link"><i class="fa fa-table me-2"></i>Category</a>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-chart-bar me-2"></i>Report</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="TrainerBookingReport.php" class="dropdown-item">Trainer Booking</a>
                            <a href="NutritionistBookingReport.php" class="dropdown-item">Nutritionist Booking</a>

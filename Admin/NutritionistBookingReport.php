        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Nutritionist</th>
            ...
            include("../Assets/Connection/connection.php");
				...
				$i=0;
			 $selQry = "select * from tbl_nutrition";
				 ...
				 $rs = $con->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					 ...
					 $selQry2 = "select COALESCE(count(booking_id),0) as num from tbl_booking b inner join tbl_nutrition c on c.nutrition_id=b.nutrition_id where b.nutrition_id='".$data["nutrition_id"]."'";
					   
					   if(isset($_POST["btn_search"]))
						{
							$selQry2 = $selQry2." and date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
						}
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["nutrition_name"]; ?></td>

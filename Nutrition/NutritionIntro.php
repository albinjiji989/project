...
if(isset($_POST["btnsubmit"]))
{
	...
	move_uploaded_file($photopath,"../Assets/Files/Nutrition/Introduction/".$photo);
	move_uploaded_file($demopath,"../Assets/Files/Nutrition/Introduction/".$demo);
	
	

	$insqry="insert into nutrition_intro(introduction,demo_image,other_image,nutrition_id)value('".$introduction."','".$demo."','".$photo."','".$trainerid."')";
       	 	...
       	 	if($con->query($insqry))
       {
          ...
          <script>
          alert(' Uploaded');
		  		window.location="NutritionIntro.php";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" align="center" style="font-size: 20px;">
  <table width="100%" border="1" align=center>
   <tr>
      <td>Introduction</td>
      <td><textarea name="txtintroduction" id="txtintroduction" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td width="176">Demo Plan as a image</td>
    ...
    <tr>
      <td colspan="2" id="submit" align="center"><input type="submit" name="btnsubmit" id="btnsubmit" value="Submit" />

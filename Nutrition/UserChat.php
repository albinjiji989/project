...
<body>
                ...
                <div class="nav-start">
                    <div class="recipient-block">
                        <div class="avatar-container">
                            <img class="user-avatar" src="../Assets/Files/User/<?php echo $row["user_photo"] ?>" alt="">
                        </div>
                        <div class="username">
    ...
    function sendChat(id) {
        ...
        if (chat.length <= 35) {
            $.ajax({
                url: "../Assets/AjaxPages/UserNAjaxChat.php?chat=" + chat + "&id=" + id,
    ...
    $(document).ready(function() {
        setInterval(function() {
            $("#conversation").load('UserLoad.php?id=<?php echo $_GET["id"] ?>')
        }, 50);
    });
    </script>

...
while($data=$res->fetch_assoc())
{
   ...
   $query = "SELECT * FROM tbl_review where nutrition_id = '" .$data["nutrition_id"]. "' ORDER BY review_id DESC";
  $rs1 = $con->query($query);
...
?>
<td>
<a href="NutritionViewMore.php?did=<?php echo $data["nutrition_id"]?>">
<div>
<p><img src="../Assets/Files/Trainer/<?php echo $data["nutrition_photo"]; ?>" width="200px"  /></p>
<p> <?php
            if ($average_rating == 5) {
...
<p><h4><font color="white">NAME: <?php echo $data["nutrition_name"];?></font></h4></p>
<p><h4><font color="white">SUBSCRIPTION: <?php echo $data["monthly_subscription"];?></font></h4></p>
</div>

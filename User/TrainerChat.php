...
$sel = "select * from tbl_trainer where trainer_id='" . $_GET["id"] . "'";
$res =$con->query($sel);
$row = $res->fetch_assoc();
?>
<!DOCTYPE html>
...
<body>
                ...
                <div class="nav-start">
                    <div class="recipient-block">
                        <div class="avatar-container">
                            <img class="user-avatar" src="../Assets/Files/Trainer/<?php echo $row["trainer_photo"] ?>" alt="">
                        </div>
                        <div class="username">
    ...
    function sendChat(id) {
        ...
        if (chat.length <= 35) {
            $.ajax({
                url: "../Assets/AjaxPages/TrainerAjaxChat.php?chat=" + chat + "&id=" + id,
    ...
    $(document).ready(function() {
        setInterval(function() {
            $("#conversation").load('TrainerLoad.php?id=<?php echo $_GET["id"] ?>')
        }, 50);
    });
    </script>

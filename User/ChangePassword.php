	    ...
	    if($password==$currentpassword)
           {
			   if($newpassword == $confirmpassword)
			    {
						$upQ="update tbl_user set user_password='".$newpassword."' where user_id='".$userid."'";
	
	 if($con->query($upQ))
       {
		   ?>
          <script>
          alert('Passwoerd Updated');
...
<tr>      <td id="login">CURRENT PASSWORD</font></td>
      <td align="center" id="user"><input type="password" name="txtcpassword" id="txtcpassword"  /></td>
    </tr>
<tr>      <td id="login">NEW PASSWORD</font></td>
      <td align="center" id="user"><input type="text" name="txtnpassword" id="txtnpassword" /></td>
    </tr>
<tr>      <td id="login">CONFIRM PASSWORD</font></td>
      <td align="center" id="user"><input type="password" name="txtrpassword" id="txtrpassword" /></td>
    </tr>
<tr>      <td height="41" colspan="2" align="center"><input type="submit" name="btnsave" id="btnsave" value="CHANGE" />

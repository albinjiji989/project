...
if(isset($_POST['btnsave']))
{
	...
	$password=$data["trainer_password"];
	    ...
	    if($password==$currentpassword)
           {
			   if($newpassword == $confirmpassword)
			    {
						$upQ="update tbl_trainer set trainer_password='".$newpassword."' where trainer_id='".$trainerid."'";
...
<form id="form1" name="form1" method="post" action="" align="center">
  <table border-style="none" align="center">
    <tr>
      <td width="150"><div class="a">Current Password</div></td>
      <td width="300" id="user"><input type="password" name="txtcpassword" id="txtcpassword" required /></td>
    </tr>
    <tr>
      <td><div class="a">New Password</div></td>
      <td id="user"><input type="text" name="txtnpassword" id="txtnpassword" style="font-size: 20px;" required /></td>
    </tr>
    <tr>
      <td><div class="a">Confirm Password</div></td>
      <td id="user"><input type="password" name="txtrpassword" id="txtrpassword" required /></td>
    </tr>
    <tr>
      <td height="41" colspan="2" align="center" id="submit"><input type="submit" name="btnsave" id="btnsave" style="font-size: 20px;" value="Change" />
